...
<body class="landing">
	...
	<section id="banner">
		<div class="inner">
			<h2>HEAL 325 Final Project Contents</h2>
			<!-- PROJECT START -->
			<div class="container">
				<iframe src="https://drive.google.com/embeddedfolderview?id=0B0i_bZSaxy7AVDF4X3BIczhEdjg#grid" width="900px" height="504px" frameborder="0"></iframe>
			</div>
			<!-- / PROJECT END -->
			<!-- Copyright Signature -->
			<script>
